...
using IdentityServer.Service.Pages;
using IdentityServer.Service.Pages.Consent;
using IdentityServer.Service.Pages.Device;
...
namespace IdentityServer.Service.Pages.Device
{
    ...
    public class Index : PageModel
    {
        ...
        private async Task<Pages.Device.ViewModel> BuildViewModelAsync(string userCode, InputModel model = null)
        {
